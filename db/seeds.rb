...
items = Item.create([{ name:'PC', owner_id: 1, price: 22 },
...
bookings = Booking.create([{item_id: 1, borrower_id: 2 },
...
reviews = Review.create([{reviewer_id: 1, reviewable: Item.find(3), text:'hjdkjdvfsjdsj'},
